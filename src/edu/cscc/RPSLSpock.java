...
/**
 * RPSLSpock class is used for Rock-paper-scissors-lizard-spock game.
 * It has methods for validating user's pick, generating pick for computer and checking if computer wins.
 *
...
public class RPSLSpock {
    ...
    /**
     * Checks if user's pick is valid or not.
     *
     * @param pick the user's pick
     * @return if user's pick is valid or not
     */
    ...
    /**
     * Checks if computer wins or not.
     *
     * @param c_pick the computer's pick
     * @param h_pick the user's pick
     * @return if computer wins or not
     */
